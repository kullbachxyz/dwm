...
static const int singleborder       = 1;        /* 1: keep border on a single/monocle window; 0: hide it (noborder) */
...
static char *colors[][3]      = {
	...
	[SchemeSel]  = { selfgcolor,     selbgcolor,     selbordercolor  }, /* active tag / focused */
};
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,		          XK_r,      spawn,          {.v = (const char*[]){ TERMINAL, "-e", "htop", NULL } } },
	...
	{ MODKEY,                       XK_space,  spawn,          SHCMD("j4-dmenu-desktop --no-generic --dmenu='dmenu -i -c -l 12 -p Apps'") },
	...
	/* vanitygaps: Super+Alt (+Shift to decrease) */
	{ MODKEY|Mod1Mask,              XK_0,      incrgaps,       {.i = +1 } },
	{ MODKEY|Mod1Mask|ShiftMask,    XK_0,      incrgaps,       {.i = -1 } },
	...
	{ MODKEY|Mod1Mask,              XK_backslash, defaultgaps, {0} },
